...
export function nodeApiMeta(exportName) {
  const map = new Map(Object.entries({
    ...
    "./dev-delivery-authority": { group: "governance-versioning", summary: "Opt-in bounded Qualification Lease, exclusive Landing Warrant, exact v1 migration, admission, and terminal settlement APIs." },
    "./dev-delivery-warrant": { group: "governance-versioning", summary: "Durable single-flight Warrant queue, fenced lease, and split source and integration proof APIs." },
    ...
    "./buildchain-delivery-self-dogfood": { group: "release-passport-trust", summary: "Pure exact-package self-dogfood assembly through injected published N-1 Buildchain and KFD abilities." },
    "./published-delivery-authority": { group: "release-passport-trust", summary: "Exact npm archive-byte loading and constrained N-1 delivery authority imports with guaranteed cleanup." },
