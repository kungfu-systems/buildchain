...
| Governance, Versioning, and Runtime Drift | `buildchain-contract.json`, `workflow-registry.json`, `release-model.json` | [`compatibility-fact-authority.md`](compatibility-fact-authority.md), [`github-governance-authority.md`](github-governance-authority.md), [`release-governance.md`](release-governance.md), [`release-flow.md`](release-flow.md), [`next-development-transition.md`](next-development-transition.md), [`versioning.md`](versioning.md), [`runtime-train-validation.md`](runtime-train-validation.md), [`cli.md`](cli.md) |
...
| Floating `@v3` drift detection, compatibility Facts, and issues | `dist/site/buildchain-contract.json` | [`compatibility-fact-authority.md`](compatibility-fact-authority.md), [`reusable-build-surface.md`](reusable-build-surface.md#floating-ref-contract-lock) |
...
| How do I evaluate one project instance through an exact protocol driver and artifact profile without copying KFD semantics? | [`adopter-delivery-gate.md`](adopter-delivery-gate.md) | use/verify | preview |
