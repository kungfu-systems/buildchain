...
| KFD-1 / KFD-2 / KFD-3 / KFD-7 / KFD Agent Runtime release-passport gates | `dist/site/kfd-claims.json`, `dist/site/buildchain-contract.json`, `dist/site/artifact-schemas.json`, `buildchain.release.json` | [`release-passport.md`](release-passport.md) |
...
| How do I publish independently verified KFD Agent Runtime conformance without overstating adoption? | [`release-passport.md`](release-passport.md#kfd-agent-runtime-conformance-passport) + [`kfd-support.md`](kfd-support.md#kfd-agent-runtime-profile) + [`cli.md`](cli.md) | verify/use | qualifying |
