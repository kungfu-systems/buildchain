...
[`capability-parity-live-capability-inventory.json`](capability-parity-live-capability-inventory.json)
...
```sh
node scripts/check-capability-parity-inventory.mjs
```
...
```sh
node scripts/check-capability-parity-inventory.mjs --write
```
