...
authority is [`capability-state-machine-manifest.json`](capability-state-machine-manifest.json),
...
[`bootstrap-authority.json`](bootstrap-authority.json). The exact source,
...
[`rust-wasm-production-authority.json`](rust-wasm-production-authority.json):
...
[`rust-libnode-bridge-spike.md`](rust-libnode-bridge-spike.md). Wave 0
...
[`stage-capsule-contract.json`](stage-capsule-contract.json). It fixes one
...
[`stage-capsule-store-contract.json`](stage-capsule-store-contract.json).
...
[`stage-capsule-qualification.json`](stage-capsule-qualification.json).
...
[`provider-operation-journal-contract.json`](provider-operation-journal-contract.json).
...
[`release-activation-shadow-domain.json`](release-activation-shadow-domain.json).
...
[`stable-publication-fence.json`](stable-publication-fence.json). It
...
[`partial-mutation-recovery-qualification.json`](partial-mutation-recovery-qualification.json).
