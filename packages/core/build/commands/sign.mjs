...
export async function controlSigning() {
  ...
  try {
    if (request.request.count) {
      authority = await script("packages/core/build/commands/dispatch-artifact-signing-authority.mjs", {
...
export async function prepareCredential() {
  ...
  const { loadCredentialInput } = await import("../macos-credential-island/lib.js");
