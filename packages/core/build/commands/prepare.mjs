...
export async function prepareEnvironment() {
  ...
  await script("packages/core/providers/commands/locked-source-checkout.mjs", { ...commonEnv(plan, platform),
  ...
  if (platform.provider === "aws-codebuild") {
    await script("packages/core/providers/commands/aws-runner-burst.mjs", { ...env, BUILDCHAIN_BURST_EVIDENCE_PATH: `${evidenceRoot}/aws-runner-burst.json`,
    ...
    await script("packages/core/providers/commands/aws-codebuild-toolchain.mjs", { BUILDCHAIN_BURST_TOOLCHAIN_EVIDENCE_PATH: `${evidenceRoot}/aws-native-toolchain.json` }, ["prepare"], { cwd: sourceRoot });
  }
