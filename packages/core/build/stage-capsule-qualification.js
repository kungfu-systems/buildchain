...
function validateAuthorityAndRuns(value) {
  if (
    ...
    value.productionAuthority !== "v4-native" ||
    ...
    fault(
      ...
      "$",
      "qualification cannot move production authority or enable effects",
    );
...
function validateMetricsAndRollback(value) {
  ...
  if (
    value.rollback.switch !== "stage-capsule-mode=disabled" ||
    value.rollback.productionAuthority !== "v4-native" ||
