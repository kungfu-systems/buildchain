...
import { PAPER_ALPHA_PLAN_CONTRACT, PAPER_BUILD_PLAN_CONTRACT, PAPER_MIGRATION_CONTRACT, PAPER_NPM_BOOTSTRAP_CONTRACT, PAPER_PREFLIGHT_CONTRACT, PAPER_RESUME_PLAN_CONTRACT, PAPER_SCAFFOLD_CONTRACT, PAPER_STATUS_CONTRACT } from "../operations/identity.js";
...
import { createPaperAlphaPlan, createPaperBuildPlan, createPaperResumePlan } from "../operations/plans.js";
import { executePaperNpmBootstrap } from "../operations/bootstrap.js";
import { verifyPublicationReproducibility } from "../../publication/publication-reproducibility.js";
import {
  ...
  try {
    ...
    if (paperAgent.handled) {
      ...
      result = executePaperNpmBootstrap({
        ...
        workflow: readFlag(effectiveArgs, "workflow", "public-release-paper.yml"),
