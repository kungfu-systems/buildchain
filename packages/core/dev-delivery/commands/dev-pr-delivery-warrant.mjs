...
function exactWarrantBinding({ result, warrant, candidate, options, pullRequest }) {
  ...
  requireMatch(["ready", "qualified"].includes(warrant.phase), "delivery-warrant-not-qualified");
...
export async function verifyCurrentDeliveryWarrant(client, options, pullRequest, warrant) {
  ...
  requireMatch(["ready", "qualified"].includes(active?.phase), "delivery-warrant-current-not-qualified");
