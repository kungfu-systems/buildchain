...
} from "../dev-delivery/dev-delivery-common.js";
import { evaluateBuildchainChannelBinding } from "../consumer/buildchain-channel-identity.js";
import {
...
export function renderBuildchainContractDriftIssueBody({
  ...
  return [
    ...
    `- Compatibility Fact registry: ${shown(accepted.compatibilityFactRegistryRoot, "(missing Fact registry)")}`,
    `- Compatibility proof registry: ${shown(accepted.compatibilityProofRegistryRoot, "(missing proof registry)")}`,
