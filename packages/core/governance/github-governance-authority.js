...
const PUBLIC_REPOSITORY_TARGETS = Object.freeze({
  ...
  buildchain: [
    target("dev/v4/v4.1", [check("check")], false, []),
    target("alpha/v4/v4.1", [check("check"), check("verify")], false),
    target("release/v4/v4.1", [check("check")], true),
    target("authority/v4/v4.1/artifact-signing", [check("check")], true),
