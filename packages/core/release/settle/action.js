...
async function main() {
  ...
  if (rehearsalCapsuleInput) {
    ...
    const candidateRootInput = input("candidate-root");
    ...
    core.setOutput("rehearsal-capsule-root", result.evidence.capsuleRoot);
    core.setOutput("rehearsal-evidence-path", evidencePath);
    core.setOutput(
      "receipt-roots-json",
      JSON.stringify(
