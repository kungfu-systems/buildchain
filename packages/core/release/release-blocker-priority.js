...
export function createReleaseBlockerPriorityClaim(repairInput, input = {}) {
  exactFields(input, ["sourceRoot", "issuedAt"], "release blocker Work identity");
  ...
  const body = {
    ...
    sourceRoot: exactRoot(input.sourceRoot, "sourceRoot"),
...
export function normalizeReleaseBlockerPriorityClaim(
  ...
  const body = {
    ...
    sourceRoot: exactRoot(input.sourceRoot, "releaseBlockerPriority.sourceRoot"),
  ...
  if (
    body.sourceRoot !== candidate.sourceRoot
  ) {
