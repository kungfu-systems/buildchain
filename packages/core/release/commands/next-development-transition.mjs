...
import { materializeNextDevelopmentTransition } from "../next-development-transition.js";
...
function usage() {
  return `usage: node packages/core/release/commands/next-development-transition.mjs materialize --input <request.json> [--cwd <checkout>] [--write]\n`;
}
