...
} from "../../publication/publication-rehearsal.js";
...
export async function runReleaseTailCli(args = process.argv.slice(2)) {
  ...
  throw new Error(
    "usage: buildchain release-tail <plan|init|status|verify|rehearse> [--declaration <json-or-path>] [--capsule <absolute-path>] [--candidate-root <absolute-path>|--capsule-root <absolute-path>] [--environment-json <empty-json-or-path>] [--mode <simulate|replay>] [--state <absolute-path>] [--evidence <absolute-path>] [--output <path>]",
  );
}
