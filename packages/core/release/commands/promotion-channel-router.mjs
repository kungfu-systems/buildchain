...
import { resolveBuildchainChannel } from "../../consumer/commands/buildchain-channel-router.mjs";
...
const TARGETS = [
  ...
  { pattern: /^publish-gate\/major$/, publicationChannel: "major", shellChannel: "stable" },
];
