...
import { normalizeControllerReceiptReferences, validateControllerReceiptReference } from "../observability/controller-evidence.js";
...
function normalizeTargetChannel(value) {
  ...
  if (normalized === "publish-gate/major") {
    return "major";
  }
  return normalized;
}
