export const BUILDCHAIN_USAGE = `Usage:
  ...
  buildchain init [--cwd <dir>] [--type npm|binary|paper|package|native|publication-artifact|anchored-package] [--force]
...
Examples:
  ...
  buildchain release --dry-run --target-ref alpha/v4/v4.1
  ...
  buildchain audit publication-control-plane --repository kungfu-systems/buildchain --branch release/v4/v4.1
