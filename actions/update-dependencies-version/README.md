...
Buildchain v1 implementation of the update-dependencies-version GitHub Action.
...
- Published action path: `kungfu-systems/buildchain/actions/update-dependencies-version@v1`
