...
fn run() -> Result<(), String> {
    ...
    match args.as_slice() {
        ...
        _ => Err("usage: buildchain-v4-contracts [trace|stage-capsule|stage-capsule-store|provider-operation-journal|provider-readback|resume-plan INPUT.json|host]".to_owned()),
    }
}
